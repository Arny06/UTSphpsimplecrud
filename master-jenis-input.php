...
if(isset($_GET['status'])){
    if($_GET['status'] == 'failed'){
        echo "<script>alert('Gagal menambahkan data Jenis Sepatu. Silakan coba lagi.');</script>";
    }
}
			...
			<main class="app-main">
				...
				<div class="app-content-header">
					<div class="container-fluid">
						<div class="row">
							<div class="col-sm-6">
								<h3 class="mb-0">Input Jenis sepatu</h3>
							</div>
							<div class="col-sm-6">
                                    ...
                                    <form action="proses/proses-jenis.php?aksi=inputjenis" method="POST">
									    <div class="card-body">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="kode" name="kode" placeholder="Masukkan Kode Jenis sepatu" required>
                                            </div>
											<div class="mb-3">
