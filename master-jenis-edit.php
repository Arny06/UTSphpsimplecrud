...
if(isset($_GET['status'])){
    if($_GET['status'] == 'failed'){
        echo "<script>alert('Gagal mengubah data jenis sepatu. Silakan coba lagi.');</script>";
    }
}
			...
			<main class="app-main">
				...
				<div class="app-content-header">
					<div class="container-fluid">
						<div class="row">
							<div class="col-sm-6">
								<h3 class="mb-0">Edit Jenis Sepatu</h3>
							</div>
							<div class="col-sm-6">
							...
							<div class="col-12">
								<div class="card">
									<div class="card-header">
										<h3 class="card-title">Formulir Jenis Sepatu</h3>
                                    ...
                                    <form action="proses/proses-jenis.php?aksi=updatejenis" method="POST">
									    <div class="card-body">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control-plaintext" id="kode" name="kode" placeholder="Masukkan Kode Jenis Sepatu" value="<?php echo $dataJenis['id']; ?>" required readonly>
                                            </div>
											<div class="mb-3">
												<label for="nama" class="form-label">Nama Sepatu<label>
												<input type="text" class="form-control" id="nama" name="nama" placeholder="Masukkan Nama Sepatu" value="<?php echo $dataJenis['nama']; ?>" required>
											</div>
                                        </div>
