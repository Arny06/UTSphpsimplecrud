			...
			<main class="app-main">
				...
				<div class="app-content-header">
					<div class="container-fluid">
						<div class="row">
							<div class="col-sm-6">
								<h3 class="mb-0">Data Jenis Sepatu</h3>
							</div>
							<div class="col-sm-6">
								<ol class="breadcrumb float-sm-end">
									<li class="breadcrumb-item"><a href="index.php">Beranda</a></li>
									<li class="breadcrumb-item active" aria-current="page">Master Jenis Sepatu</li>
								</ol>
							</div>
						</div>
					</div>
							...
							<div class="col-12">
								<div class="card">
									...
									<div class="card-footer">
										<button type="button" class="btn btn-primary" onclick="window.location.href='master-jenis-input.php'"><i class="bi bi-plus-lg"></i> Tambah Jenis Sepatu</button>
									</div>
								</div>
							</div>
						</div>
