														...
														foreach ($dataSepatu as $index => $sepatu){
															...
															echo '<tr class="align-middle">
																...
																<td class="text-center">
																	...
																	<button type="button" class="btn btn-sm btn-danger" onclick="if(confirm(\'Yakin ingin menghapus data mahasiswa ini?\')){window.location.href=\'proses/proses-delete.php?id='.$sepatu['kode_sepatu'].'\'}"><i class="bi bi-trash-fill"></i> Hapus</button>
																</td>
															</tr>';
														}
													}
